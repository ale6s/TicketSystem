            ...
            <div class="col-md-9 mt-2">
                <div class="profile-content text-center">
                    <form action="" method="POST">
                        ...
                        <input type="submit" class="btn btn-success btn-md" name="btn-edit-req" value="Update Ticket" />
                        <a class="btn btn-danger btn-md" href="../view/user_history.php">Cancel</a>
