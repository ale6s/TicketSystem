            ...
            <div class="col-md-9 mt-2">
                <div class="profile-content text-center">
                    <div class="row">
                        ...
                        <h1 class="col-sm-5">Tickets in Pending</h1>
                    </div>
                    <table class="table table-hover">
                        ...
                        $sql = "SELECT * FROM request_ticket ORDER BY FIELD(priority, 'high', 'medium', 'low')";
                            ...
                            <tbody id="all-tickets">
                                <tr>
                                    ...
                                    if ($rows['status'] == 'pending..') { ?>
                                        ...
                                        <td><?php echo "<a class='btn-warning btn-sm' href='../model/edit-ticket-admin.php?id=$id' >Edit</a> 
                                                        <a onClick=\"javascript: return confirm('Please confirm deletion');\" href='../model/delete-admin-req.php?id=$id' class='btn-danger btn-sm'>Delete</a> 
                                                        <a onClick=\"javascript: return confirm('Please confirm that ticket is done');\" href='../model/done_request.php?id=$id' class='btn-success btn-sm' href=''>Done</a>"; ?></td>
                                    <?php
                                    }
                                    ?>
